...
// namespace. Each lib ends with `var <exportName> = { ... }` naming what to
// expose (per-file so the scripts don't collide when type-checked together); we
// eval the source in a fresh scope and return that object.
//
...
export function loadQmlLib(relPath, exportName, globals = {}) {
